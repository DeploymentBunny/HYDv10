...
C:\Setup\HYDv10\TaskSequences\DeployADDS01-Post.ps1 -SettingsFile $SettingsFile -VHDImage $VHDImage -VMlocation $VMlocation -LogPath $Logpath

#Deploy ADDS02
$Global:Server = 'ADDS02'
$Global:Roles = 'ADDS','DHCP'
$FinishAction = 'Shutdown'
C:\Setup\HYDv10\TaskSequences\DeployADDS02-Post.ps1 -SettingsFile $SettingsFile -VHDImage $VHDImage -VMlocation $VMlocation -LogPath $Logpath

#Deploy RRAS01
$Global:Server = 'RRAS01'
$Global:Roles = 'RRAS'
$FinishAction = 'Shutdown'
C:\Setup\HYDv10\TaskSequences\DeployFABRICServer-Post.ps1 -SettingsFile $SettingsFile -VHDImage $VHDImage -VMlocation $VMlocation -LogPath $Logpath -Roles $Roles -Server $Server -FinishAction $FinishAction -KeepMountedMedia
